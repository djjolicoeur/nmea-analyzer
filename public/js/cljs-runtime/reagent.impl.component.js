...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12030 = c;
var G__12030__$1 = (((G__12030 == null))?null:G__12030.prototype);
if((G__12030__$1 == null)){
return null;
} else {
return G__12030__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12033 = c;
var G__12033__$1 = (((G__12033 == null))?null:G__12033.prototype);
if((G__12033__$1 == null)){
return null;
} else {
return G__12033__$1.render;
}
})() == null)))));
});
...
var or__5025__auto__ = (function (){var G__12041 = c;
var G__12041__$1 = (((G__12041 == null))?null:G__12041.constructor);
if((G__12041__$1 == null)){
return null;
} else {
return G__12041__$1.displayName;
}
})();
...
var G__12042 = c;
var G__12042__$1 = (((G__12042 == null))?null:G__12042.constructor);
if((G__12042__$1 == null)){
return null;
} else {
return G__12042__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__12043 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12044 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12044);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12043);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__12045 = key;
var G__12045__$1 = (((G__12045 instanceof cljs.core.Keyword))?G__12045.fqn:null);
switch (G__12045__$1) {
...
var c = this;
var G__12083_12133 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12083_12133 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12083_12133);
}
...
var renders_12136 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12137 = cljs.core.first(cljs.core.vals(renders_12136));
...
if((cljs.core.count(renders_12136) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12136))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12137)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12137], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__12115 = o;
reagent.impl.component.goog$module$goog$object.set(G__12115,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__12119 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12120 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12120);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12119);
}});
...
var vec__12121 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12121,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12121,(1),null);
...
var G__12124 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__12124 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__12124);
}
});
}),[]);
