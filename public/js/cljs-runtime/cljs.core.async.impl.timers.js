...
var i_14429 = (0);
while(true){
if((i_14429 < arr.length)){
(arr[i_14429] = null);

var G__14430 = (i_14429 + (1));
i_14429 = G__14430;
continue;
} else {
}
...
var i_14443 = (self__.level + (1));
while(true){
if((i_14443 <= (new_level + (1)))){
(update[i_14443] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14447 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14447[i]));
} else {
x__$2.forward.push((((i < links_14447.length))?(links_14447[i]):null));
}

if((i < links_14447.length)){
(links_14447[i] = x__$2);
} else {
links_14447.push(x__$2);
}
...
var links_14451 = (update[i_14449]).forward;
if((x__$1 === (((i_14449 < links_14451.length))?(links_14451[i_14449]):null))){
(links_14451[i_14449] = (x__$1.forward[i_14449]));

var G__14452 = (i_14449 + (1));
i_14449 = G__14452;
continue;
} else {
var G__14453 = (i_14449 + (1));
i_14449 = G__14453;
continue;
}
} else {
